...
class CloudStairs(baseBlockState: BlockState?, settings: Settings?) : StairsBlock(baseBlockState, settings), CloudAttribute{
    ...
    override fun isSideInvisible(state: BlockState, stateFrom: BlockState, direction: Direction): Boolean {
        val isSideInvisible = super<StairsBlock>.isSideInvisible(state, stateFrom, direction)
    ...
    override fun onEntityCollision(state: BlockState, world: World, pos: BlockPos, entity: Entity) {
        ...
        if (!PowderSnowBlock.canWalkOnPowderSnow(entity)) {
            ...
            super<StairsBlock>.onEntityCollision(state, world, pos, entity)
        }
    ...
    override fun getCollisionShape(
        ...
        var entity: Entity? = (context as? EntityShapeContext)?.entity
            ?: return super<StairsBlock>.getCollisionShape(state, world, pos, context)
