...
class CloudGate(settings: Settings?) : FenceGateBlock(settings), CloudAttribute {
    ...
    override fun isSideInvisible(state: BlockState, stateFrom: BlockState, direction: Direction): Boolean {
        val isSideInvisible = super<FenceGateBlock>.isSideInvisible(state, stateFrom, direction)
    ...
    override fun onEntityCollision(state: BlockState, world: World, pos: BlockPos, entity: Entity) {
        ...
        if (!PowderSnowBlock.canWalkOnPowderSnow(entity)) {
            ...
            super<FenceGateBlock>.onEntityCollision(state, world, pos, entity)
        }
    ...
    override fun getCollisionShape(
        ...
        var entity: Entity? = (context as? EntityShapeContext)?.entity
            ?: return super<FenceGateBlock>.getCollisionShape(state, world, pos, context)
