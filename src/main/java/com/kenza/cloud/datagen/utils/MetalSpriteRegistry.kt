package com.kenza.cloud.datagen.utils

import com.kenza.cloud.datagen.utils.*
...
object MetalSpriteRegistry {
        ...
        init {
            ...
            putBlock("deepslate_lead_ore", MetalModel.Builder().deepslateOre().oreBase(LEAD_BASE).oreHighlight(
                LEAD_HIGHLIGHT
            ).build())
            ...
            put("molten_lead_bucket", MetalModel.Builder().bucket().moltenBucketBase(LEAD_BASE).moltenBucketHighlight(
                LEAD_HIGHLIGHT
            ).build())
            ...
            putBlock("deepslate_silver_ore", MetalModel.Builder().deepslateOre().oreBase(SILVER_BASE).oreHighlight(
                SILVER_HIGHLIGHT
            ).build())
            ...
            put("molten_silver_bucket", MetalModel.Builder().bucket().moltenBucketBase(SILVER_BASE).moltenBucketHighlight(
                SILVER_HIGHLIGHT
            ).build())
            ...
            put("molten_copper_bucket", MetalModel.Builder().bucket().moltenBucketBase(COPPER_BASE).moltenBucketHighlight(
                COPPER_HIGHLIGHT
            ).build())
            ...
            put("molten_tin_bucket", MetalModel.Builder().bucket().moltenBucketBase(TIN_BASE).moltenBucketHighlight(
                TIN_HIGHLIGHT
            ).build())
            ...
            putBlock("deepslate_nikolite_ore", MetalModel.Builder().deepslateOre().oreBase(NIKOLITE_BASE).oreHighlight(
                NIKOLITE_HIGHLIGHT
            ).build())
            ...
            put("molten_netherite_bucket", MetalModel.Builder().bucket().moltenBucketBase(NETHERITE_SCRAP_BASE).moltenBucketHighlight(
                NETHERITE_SCRAP_HIGHLIGHT
            ).build())
